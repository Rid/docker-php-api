...
class ClientAsync extends \Jane\OpenApiRuntime\Client\AmpArtaxClient
{
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\ContainerWait($id, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\ContainerArchive($id, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\ContainerArchiveInfo($id, $queryParameters), $fetch);
    }
     ...
     *
     * @return \Amp\Promise<\Docker\API\Model\VersionGetResponse200|\Amp\Artax\Response|null>
     */
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\NetworkInspect($id, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\PluginList($queryParameters), $fetch);
    }
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\PluginUpgrade($name, $body, $queryParameters, $headerParameters), $fetch);
    }
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\ServiceInspect($id, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\TaskLogs($id, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\SecretUpdate($id, $body, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\ConfigList($queryParameters), $fetch);
    }
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\ConfigCreate($body), $fetch);
    }
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\ConfigDelete($id), $fetch);
    }
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\ConfigInspect($id), $fetch);
    }
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\ConfigUpdate($id, $body, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\DistributionInspect($name), $fetch);
    }
    ...
    {
        return $this->executeArtaxEndpoint(new \Docker\API\Endpoint\Session(), $fetch);
    }
